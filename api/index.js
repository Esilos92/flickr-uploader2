module.exports = (req, res) => {
  // Check if Flickr env vars exist with CORRECT names
  const envVars = {
    ...
    FLICKR_ACCESS_TOKEN_SECRET: !!process.env.FLICKR_ACCESS_TOKEN_SECRET,  // Fixed!
  ...
  res.status(200).json({
    message: 'Environment check with correct variable names',
    envVarsSet: envVars,
